...
type GoodsFilterRequest struct {
	...
	IsTab       bool   `protobuf:"varint,5,opt,name=isTab,proto3" json:"isTab,omitempty"`             // 是否在tab页面展示
	...
	KeyWords    string `protobuf:"bytes,9,opt,name=keyWords,proto3" json:"keyWords,omitempty"` //对商品进行查询
	Brand       int32  `protobuf:"varint,10,opt,name=brand,proto3" json:"brand,omitempty"`     //品牌查询
}
